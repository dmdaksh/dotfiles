...
M.load_plugin_syntax = function(palette)
    return {
        ...
        TSFunction = {fg = palette.green, style = 'italic'},
        TSFuncBuiltin = {fg = palette.aqua},
        TSFuncMacro = {fg = palette.green, style = 'italic'},
        TSKeyword = {fg = palette.pink, style = 'italic'},
        TSKeywordFunction = {fg = palette.pink, style = 'italic'},
...
local default_config = {palette = M.classic, custom_hlgroups = {}}
...
M.setup = function(config)
    ...
    async_load_plugin = vim.loop.new_async(
            ...
            plugin_syntax = vim.tbl_deep_extend('keep', config.custom_hlgroups,
                                                plugin_syntax)
